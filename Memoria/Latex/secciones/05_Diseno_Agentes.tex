...
\begin{itemize}
	...
	\item \textbf{weights:} Incluye todos los pesos pre-entrenados de las variantes propuestas del agente, junto a pesos pre-entrenados para un agente usando \textit{PPO} implementado por \textit{Habitat}.
