...
#
# This file contains the original implementation of the
# Reactive Navigation main model, used by both the
...
#   * TURN LEFT
#
# This approach was abandoned due to memory leak problems with TensorFlow
# impeding the model's training
...
class ReactiveNavigationModelKeras:
    """
    ...
    This model has been deprecated due to memory leaks in Tensorflow.
    Use ReactiveNavigationModel instead.
    """
